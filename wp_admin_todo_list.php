...
add_action( 'admin_print_footer_scripts', 'sm_admin_todo_functions' , 100 );
function sm_admin_todo_functions() {
...
?>
	<script type="text/javascript">
		...
		jQuery(function() {
			if (jQuery(".sm_at_div_wrapper").length) {
...
function my_admin_footer_function() {
	...
	.sm_at_textarea_div .draggable_handle {
		padding: 3px;
		margin-right: 5px;
		color: #777777;
		cursor: move;
